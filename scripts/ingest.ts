/**
 * The Ingest class is responsible for loading and processing documents from a directory,
 * splitting the documents into chunks, and storing them in a Chroma vector store.
 * It also performs a similarity search and deletes existing documents if necessary.
 */
